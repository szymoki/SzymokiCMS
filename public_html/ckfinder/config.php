...
$config['authentication'] = function () {
    ...
    return require_once '/home/loken/domains/loken.pl/public_html/loken/CI.php';
};

/*============================ License Key ============================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = 'loken.szymonyo.tk';
$config['licenseKey']  = '*979-*1**-K**3-*K**-*C**-7*8*-3**J';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/upload_media',
  'root'         => '/home/loken/domains/loken.pl/public_html/upload_media', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
