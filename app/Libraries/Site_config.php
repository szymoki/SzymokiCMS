 ...
 * @Last Modified time: 2020-05-03 14:46:20
...
class Site_Config {
    ...
    function prepare_page_menu($main_page_id,$current_page,$unset=false){
        ...
        if(!$unset){
            $menu[]=(object)array("title"=>$first_page->title,"id"=>$first_page->id,"url"=>generate_page_url($first_page,$ptype),"active"=>$active,"childs"=>array());
        }
