    ...
    <div class="container">
        <div class="row">
            ...
            <div class="about-desc animate-box startup" style="">
                  ...
                  <div class="intro-flex" >
    <div class="stowarzyszenie one-third color-3 animate-box " style="">
        <span class="icon" style="  top:0;"><i class="flaticon-student"></i></span>
        <div class="desc" style="">
        <a href="http://stowarzyszenie.awaxkomp.web.priv.pl/" target="_blank">   <h3 style="color:white;">Stowarzyszenie Absolwentów i Przyjaciół LO im. KEN</h3></a>
        </div>
    </div>
</div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <? foreach ($news as $key => $item): ?>
                    ...
                    <? endif; ?>
                    <div class="desc">
                        <h2><a href="<?= base_url() ?>/news/<?= $item->id ?>"><?= $item->title ?></a></h2>
                        <hr class="blue_line mt10 mb10"/>
                        <p class="admin" style="">
                            <span>  <a href="<?=base_url("news/category/".$item->category)?>"><?= $categories[$item->category] ?></a> <?= $item->edited_date ?></span> <i style="color:black;"class="icon-calendar"> </i>
                        </p>
                        <?= news($item->text) ?>
...
<? if (true): ?>
    ...
    style="background-image: url(<?= base_url() ?>/themes/eskwela/images/img_bg_2.jpg);"
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="col-md-3 col-sm-6 animate-box">
                    <div class="counter-entry">
                        ...
                        <div class="desc">
                            ...
                            data-to="<?= $licznik["licznik1"] ?>" data-speed="5000"
                ...
                <div class="col-md-3 col-sm-6 animate-box">
                    <div class="counter-entry">
                        ...
                        <div class="desc">
                            <span class="colorlib-counter js-counter" data-from="0"
                            data-to="<?= $licznik["licznik2"] ?>" data-speed="5000"
                            data-refresh-interval="50"></span>
                ...
                <div class="col-md-3 col-sm-6 animate-box">
                    <div class="counter-entry">
                        ...
                        <div class="desc">
                            <span class="colorlib-counter js-counter" data-from="0"
                            data-to="<?= $licznik["licznik3"] ?>" data-speed="5000"
                            data-refresh-interval="50"></span>
                ...
                <div class="col-md-3 col-sm-6 animate-box">
                    <div class="counter-entry">
                        ...
                        <div class="desc">
                            <span class="colorlib-counter js-counter" data-from="0"
                            data-to="<?= $licznik["licznik4"] ?>" data-speed="5000"
                            data-refresh-interval="50"></span>
...
<? if (zmienna("uczniowie_on") == "1"): ?>
    <div id="colorlib-testimony" class="testimony-img"
    style="background-image: url(<?= base_url() ?>/themes/eskwela/images/img_bg_2.jpg);"
    data-stellar-background-ratio="0.5">
    <div class="overlay"></div>
    <div class="container">
                        ...
                        <div class="item">
                            <div class="testimony-slide">
                                <div class="testimony-wrap">
                                    ...
                                    style="background-image: url(<?= base_url() ?>/themes/eskwela/images/person1.jpg);"></div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="testimony-slide">
                                <div class="testimony-wrap">
                                    ...
                                    <div class="figure-img"
                                    style="background-image: url(<?= base_url() ?>/themes/eskwela/images/person2.jpg);"></div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="testimony-slide">
                                <div class="testimony-wrap">
                                    ...
                                    <div class="figure-img"
                                    style="background-image: url(<?= base_url() ?>/themes/eskwela/images/person3.jpg);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<? if (true): ?>
    <div id="colorlib-services">
        <div class="container">
            <div class="row">
                <?foreach($pieciokaty as $id=>$item):?>
                <div class="col-md-3 text-center animate-box">
                    <div class="services">
                      <a class="icon" href="<?=base_url($item->url)?>">	
