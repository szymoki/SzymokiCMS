        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
                <h3 style="margin-top:-50px;margin-bottom:-30px; font-weight:700; text-transform: uppercase;">Kategoria: <?=$category?></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <? foreach ($news as $key => $item): ?>
                    <div class="f-blog animate-box" style="padding-left: 1em">
                       ...
                       <div class="desc">
                        ...
                        <p class="admin" style="">
                            <span>  <?= $categories[$item->category] ?> <?= $item->edited_date ?></span>
                        </p>
                        <?= news($item->text) ?>
