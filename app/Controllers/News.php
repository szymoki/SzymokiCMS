 ...
 * @Last Modified time: 2020-05-03 14:42:51
...
class News extends BaseController
{
	public function news($id)
	{
		...
		$dane["fb"]["title"]=$dane["title"]=$dane["news"]->title." - I Liceum Ogólnokształcące im. KEN";
	...
	public function all()
	{
		...
		$dane["fb"]["title"]=$dane["title"]="Aktualności - I Liceum Ogólnokształcące im. KEN";
