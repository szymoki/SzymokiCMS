 ...
 * @Last Modified time: 2020-05-17 12:08:40
...
class Page extends BaseController
{
	public function page($id)
	{
		...
		if($menu_item) $dane["active_menu"]=$menu_item[0]->id;
		//menu
		...
		$dane["fb"]["title"]=$dane["title"]=$dane["page"]->title." - I Liceum Ogólnokształcące im. KEN";
