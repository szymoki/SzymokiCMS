 ...
 * @Last Modified time: 2020-05-06 17:10:23
...
class Panel extends \App\Controllers\BaseController
{
	...
	public function admin(){
       ...
       $dane['visits_chart_today'] =array();// $this->vm->get_chart_data_for_today();
        $dane['visits_chart_month'] = array();//$this->vm->get_chart_data_for_month_year();
    ...
    function pass_change() {
    	...
    	if (!$validation->run($_POST)) {
    		...
    		$this->model->update($ses["id"],array("password"=>sha1($encryption->key.$this->request->getPost("new"))));   
