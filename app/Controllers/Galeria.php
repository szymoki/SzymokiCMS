 ...
 * @Last Modified time: 2020-05-21 14:51:44
...
{
	public $dir    = '/home/loken/domains/loken.pl/public_html/upload_media/gallery';
	...
	public function index()
	{
		...
		$dane["fb"]["title"]=$dane["title"]="Galeria - I Liceum Ogólnokształcące im. KEN";
	...
	public function album($id)
	{
		...
		$dane["fb"]["title"]=$dane["title"]=$album->title." - I Liceum Ogólnokształcące im. KEN";
		if(!$album){
		...
		foreach($scan as $key=>$item){
			...
			else $images[]=base_url($this->url."/".$album->folder."/".$item);
		}
	//	print_r($images);
		$dane["zdjecia"]=$images;
		$dane["album"]=$album;
